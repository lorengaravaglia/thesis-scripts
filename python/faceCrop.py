...
HAAR_CASCADE_PATH = "C:/OpenCV2.4/opencv/data/haarcascades/haarcascade_frontalface_alt.xml"
...
def test(imageFilePath):
    ...
    pil_im = cv2.imread(imageFilePath)
    cv_im=pil2cvGrey(pil_im)
    # Select one of the haarcascade files:
    #   haarcascade_frontalface_alt.xml  <-- Best one?
    #   haarcascade_frontalface_alt2.xml
...
faceCrop('C:/facedatabase/georgiaTech/gt_db/s03/*.jpg',boxScale=1)
